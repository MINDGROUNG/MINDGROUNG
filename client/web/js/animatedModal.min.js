        ...
        e.css(r),
            n.click(function (a) {
                a.preventDefault(),
                    ...
                    i == d &&
                    (e.hasClass(o.modalTarget + '-off') && (e.removeClass(o.animatedOut), e.removeClass(o.modalTarget + '-off'), e.addClass(o.modalTarget + '-on')),
            ...
            t.click(function (a) {
                l('body, html').css({ overflow: 'auto' }),
                    ...
                    (e.removeClass(o.animatedIn), e.addClass(o.animatedOut), e.one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', s));
            });
    };
})(jQuery);
