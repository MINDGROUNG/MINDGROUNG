...
CKEDITOR.editorConfig = function (config) {
    ...
    config.language = 'en'; // 언어설정 툴바 메뉴가 한글로 출력됨(대소문자 구별)
    ...
    config.extraPlugins = 'image2,youtubevideo, wordcount'; //youtubevideo : 유튜브 동영상 삽입 커스텀 플러그인
    config.wordcount = 
    ...
    config.removeButtons =
        'Maximize,CopyFormatting,RemoveFormat,Smiley,Save,NewPage,Preview,Print,Templates,Cut,Copy,Paste,PasteText,PasteFromWord,Find,Replace,SelectAll,Scayt,Form,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Strike,Checkbox,NumberedList,BulletedList,Indent,Outdent,Blockquote,CreateDiv,BidiLtr,BidiRtl,Language,Anchor,Flash,HorizontalRule,PageBreak,Iframe,ShowBlocks,About';
};
